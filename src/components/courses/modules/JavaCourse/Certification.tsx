    ...
    case 1:
      return (
        <div className={styles.tabContent} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <p className={styles.paragraph} style={{ textAlign: 'center' }}>Congratulations on completing the Java Programming Mastery course! Below is your official Course Completion Certificate.</p>
          ...
          <div style={{
            ...
            {/* Corner decorations */}
            <div style={{ position: 'absolute', top: '10px', left: '10px', fontSize: '24px', color: '#6c5ce7' }}>❖</div>
            <div style={{ position: 'absolute', top: '10px', right: '10px', fontSize: '24px', color: '#6c5ce7' }}>❖</div>
            <div style={{ position: 'absolute', bottom: '10px', left: '10px', fontSize: '24px', color: '#6c5ce7' }}>❖</div>
            <div style={{ position: 'absolute', bottom: '10px', right: '10px', fontSize: '24px', color: '#6c5ce7' }}>❖</div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '20px', padding: '0 20px', fontFamily: 'sans-serif' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '9px', color: '#94a3b8', display: 'block' }}>ID: SK-JPM-2026-1042</span>
              </div>
      ...
      return (
        <div className={styles.tabContent}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '20px', marginTop: '20px' }}>
            {[
              { title: 'Java Architect', icon: '🧱', desc: 'Unlocked after compiling Java applications structures.', color: '#6c5ce7' },
              { title: 'OOP Master', icon: '🎨', desc: 'Unlocked for configuring polymorphic class templates.', color: '#3b82f6' },
              { title: 'Collections Expert', icon: '⚡', desc: 'Unlocked for optimizing memory collections algorithms.', color: '#eab308' },
              { title: 'Spring Architect', icon: '⚛️', desc: 'Unlocked for integrating REST mapping endpoints.', color: '#06b6d4' },
              { title: 'Docker Deployer', icon: '🚀', desc: 'Unlocked for writing containers configuration files.', color: '#10b981' }
            ].map((badge, idx) => (
              <div key={idx} style={{
      ...
      return (
        <div className={styles.tabContent}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '20px' }}>
            {[
              { skill: 'Core Java & Data Types Syntax', val: 96, color: '#6c5ce7' },
              { skill: 'Object-Oriented Design (Pillars)', val: 94, color: '#3b82f6' },
              { skill: 'Collections Framework & Datastructures', val: 90, color: '#eab308' },
              { skill: 'Multi-threading & Systems concurrency', val: 82, color: '#ec4899' },
              { skill: 'Spring Boot REST Controllers & DI', val: 92, color: '#06b6d4' },
              { skill: 'Docker Containerization & Cloud Deployments', val: 86, color: '#10b981' }
            ].map((item, idx) => (
